...
class Window(QMainWindow): 
	...
	def __init__(self): 
		...
		# setting title 
		self.setWindowTitle("Covid Monitor ") 
	...
	def UiComponents(self): 
		...
		self.country = ["indonesia", "us", "spain", "china", "russia", "italy", "spain", 
												"uk", "brazil"] 
		...
		self.label_total = QLabel("Total Kasus ", self) 
		...
		self.label_reco = QLabel("Kasus Sembuh ", self) 
		...
		self.label_death = QLabel("Total Meninggal ", self) 
